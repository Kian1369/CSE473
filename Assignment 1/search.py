...
def depthFirstSearch(problem):
    ...
    while not fringe.isEmpty():
        ...
        # explore the next node in fringe (stack) if the current node is fully explored
        if state in explored:
            continue

        # get successors of the current node and add them to fringe in order to explore them later (if not yet explored)
